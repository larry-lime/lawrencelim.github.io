...
\begin{rSection}{WORK EXPERIENCE}
	...
	\begin{itemize}
		...
		\item Implemented web scraping with BeautifulSoup and Selenium, and chat message caching with Redis
...
\begin{rSection}{Technical Skills and Interests}
	\textbf{Programming Languages}{: Python, SQL, Solidity, HTML/CSS, JavaScript, C,  Shell, Lua, Rust} \\
